...
from voyage_evaluation.model import get_embedding_model
from voyage_evaluation.module.utils import gather_list
...
class Encoder(LightningModule):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__()
        self.model = get_embedding_model(model_type, model_name, **kwargs)
        self.model_type = model_type
        self.model_name = model_name
        self.embd_type = embd_type
        self.load_embds = load_embds
